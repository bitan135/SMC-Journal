    ...
    <div className="min-h-screen bg-[#050505] text-[#fafafa] selection:bg-indigo-500/30">
      ...
      <main className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="space-y-10 text-white/60 font-bold leading-relaxed">
          <section>
            <h2 className="text-xl font-black text-white mb-4 uppercase tracking-widest">1. Data Collection</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-white mb-4 uppercase tracking-widest">2. How We Use Data</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-white mb-4 uppercase tracking-widest">3. Data Security</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-white mb-4 uppercase tracking-widest">4. Third-Party Services</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-white mb-4 uppercase tracking-widest">5. Your Rights</h2>
